    ...
    public class PersonController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Person>>> GetPersons()
        {
          if (_context.Persons == null)
          {
            ...
            return await _context.Persons.Take(10).ToListAsync();
        }
        ...
        // GET: api/Person/5
        [HttpGet("{mail}")]
        public async Task<ActionResult<Person>> GetPersonByMail(string mail)
        {
            if (_context.Persons == null)
            {
                return NotFound();
            }
            var person = await _context.Persons.FirstOrDefaultAsync(x=>x.Email == mail);
